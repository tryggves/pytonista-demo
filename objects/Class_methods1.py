...
def main():
    ...
    print('\nAfter new modification to graph')
    print(f'my_first_graph edge_count: {my_first_graph.edge_count}\tcount_updates: {my_first_graph.count_updates}')
    print(f'my_second_graph edge_count: {my_second_graph.edge_count}\tcount_updates: {my_first_graph.count_updates}')
